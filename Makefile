...
LIB         := -L../lib -lgtest -lpthread $(ASAN) -lssl -lcrypto -lcurses 
LIB2        := -L/home/pi/Code/elma/lib -lelma
LIB3        := -lwiringPi -lwiringPiDev -lm -lcrypt -lrt
INC         := -I$(INCDIR)
INCDEP      := -I$(INCDIR) 
...
bin/test: $(NON_MAIN_OBJECTS) $(HEADERS) ./src/unit_test.cc ./src/test_main.cpp
	...
	$(CC) $(CFLAGS) -o bin/test test_main.o $(NON_MAIN_OBJECTS) $(LIB) $(LIB2) $(LIB3)

#Link
$(TARGETDIR)/$(TARGET): $(OBJECTS) $(HEADERS)
	$(CC) $(CFLAGS) -o $(TARGETDIR)/$(TARGET) $(OBJECTS) $(LIB) $(LIB2) $(LIB3)
